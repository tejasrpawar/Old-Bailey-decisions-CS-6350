...
def train_perceptron(x_values, label_value, learning_rate, epochs):
    ...
    for epoch in range(epochs):
        ...
        for i in range(x_values.shape[0]):
            ...
            weights, bias, c = update_weights_bias(weights, bias, x_values[i], label_value[i], new_learning_rate)
            updates += c
...
with open('tfidf_perceptron_decay.csv', 'w', newline='') as file:
